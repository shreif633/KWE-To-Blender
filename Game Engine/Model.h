...
public:
	...
	BOOL	Load(LPCSTR szName, DWORD dwFlags = 0) 	{ return Load(szName, dwFlags, this, (XCallee::FUNCTION) &CStaticModel::OnLoad);}
	...
	void	OnLoad();
#ifdef GAME_XENGINE
	BOOL	LoadModel(LPCSTR szName) { return Load(szName, 0, this, (XCallee::FUNCTION) &CStaticModel::OnLoadModel); }
	void	OnLoadModel();
...
public:
	...
	BOOL	Load(LPCSTR szName, DWORD dwFlags = 0) { 	
		return CStaticModel::Load(szName, dwFlags | CModelFile::SHADER, this, (XCallee::FUNCTION) &CModel::OnLoad); }
	void	OnLoad();
    ...
    */
	...
	BOOL	LoadModel(LPCSTR szName) {
		return CStaticModel::Load(szName, CModelFile::SHADER, this, (XCallee::FUNCTION) &CModel::OnLoadModel); }
	void	RemoveModel();
	void	OnLoadModel();
#endif
